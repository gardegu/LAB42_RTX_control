...
void Camera_API::stereo_calibration(){
...
void Camera_API::stereo_rectification(){
...
void Camera_API::stereo_split_views(){
    if(frame.empty()){
...
void Camera_API::stereo_get_disparity(){
...
void Camera_API::stereo_get_depth(){
